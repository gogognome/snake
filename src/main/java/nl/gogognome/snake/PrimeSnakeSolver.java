...
public class PrimeSnakeSolver extends JPanel {
	...
	public static void main(String[] args) {
		...
		showFrame(solver);
		solver.solve(
				"",
				5000);
	}

	public static void showFrame(PrimeSnakeSolver solver) {
	...
	public void solve(String solution, int snakeLength) {
		System.out.println("Smallest bounding square/score: "+ calculateSolution(solution, snakeLength));
		repaint();
	}
